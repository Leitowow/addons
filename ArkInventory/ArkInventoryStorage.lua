...
function ArkInventory:EVENT_ARKINV_PLAYER_MONEY( event )

	--ArkInventory.Output( "PLAYER_MONEY[ ", event, " ]" )
...
function ArkInventory:EVENT_ARKINV_COMBAT_ENTER( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_COMBAT_ENTER" )
...
function ArkInventory:EVENT_ARKINV_COMBAT_LEAVE( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_COMBAT_LEAVE" )
...
function ArkInventory:EVENT_ARKINV_BAG_UPDATE( event, blizzard_id, arg2 )
	
	--ArkInventory.Output( "BAG_UPDATE [", event, "] [ ", blizzard_id, ", ", arg2, " ]" )
	
	ArkInventory:SendMessage( "EVENT_ARKINV_BAG_UPDATE_BUCKET", blizzard_id )
	
end

function ArkInventory:EVENT_ARKINV_BAG_LOCK( event, arg1, arg2 )

	--ArkInventory.Output( "EVENT_ARKINV_BAG_LOCK: ( ", event, "( ", arg1, ",", arg2, " )" )
...
function ArkInventory:EVENT_ARKINV_TALENT_CHANGED( event )
...
function ArkInventory:EVENT_ARKINV_BANK_ENTER( event )
	
	--ArkInventory.Output( "EVENT_ARKINV_BANK_ENTER: ", event )
...
function ArkInventory:EVENT_ARKINV_BANK_LEAVE( event )
	--ArkInventory.Output( "EVENT_ARKINV_BANK_LEAVE[ ", event, " ]" )
	ArkInventory:SendMessage( "EVENT_ARKINV_BANK_LEAVE_BUCKET", event )
end

function ArkInventory:EVENT_ARKINV_BANK_LEAVE_BUCKET( events )
	
	--ArkInventory.Output( "EVENT_ARKINV_BANK_LEAVE_BUCKET[ ", events, " ]" )
...
function ArkInventory:EVENT_ARKINV_BANK_UPDATE( event, arg1 )

	-- player changed a bank bag or item

	--ArkInventory.Output( "EVENT_ARKINV_BANK_UPDATE( ", event, " ", arg1, " ) " )
...
function ArkInventory:EVENT_ARKINV_BANK_SLOT( event )

	--ArkInventory.Output( "EVENT_ARKINV_BANK_SLOT( ", event, " )" )
...
function ArkInventory:EVENT_ARKINV_BANK_TAB( event )
	
	--ArkInventory.Output( "EVENT_ARKINV_BANK_TAB( ", event, " )" )
...
function ArkInventory:EVENT_ARKINV_REAGENTBANK_UPDATE( event, arg1 )
...
function ArkInventory:EVENT_ARKINV_VAULT_LOCK( event, ... )
	...
	--local v1, v2, v3, v4
	--ArkInventory.Output( "EVENT_ARKINV_VAULT_LOCK( ", v1, ", ", v2, ", ", v3, ", ", v4, " )"  )
...
function ArkInventory:EVENT_ARKINV_TRADE_ENTER( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_TRADE_ENTER" )
...
function ArkInventory:EVENT_ARKINV_TRADE_LEAVE( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_TRADE_LEAVE" )
...
function ArkInventory:EVENT_ARKINV_AUCTION_ENTER( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_AUCTION_ENTER" )
...
function ArkInventory:EVENT_ARKINV_AUCTION_LEAVE( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_AUCTION_LEAVE" )
...
function ArkInventory:EVENT_ARKINV_MERCHANT_ENTER( event, ... )
	...
	--ArkInventory.Output( "EVENT_ARKINV_MERCHANT_ENTER: ", event )
...
function ArkInventory:EVENT_ARKINV_SCRAP_ENTER( event, ... )
	...
	--ArkInventory.Output( "EVENT_ARKINV_SCRAP_ENTER: ", event )
...
function ArkInventory:EVENT_ARKINV_SCRAP_LEAVE( event )
	...
	--ArkInventory.Output( "EVENT_ARKINV_SCRAP_LEAVE: ", event )
...
function ArkInventory:EVENT_ARKINV_TRANSMOG_ENTER( event, ... )
	...
	--ArkInventory.Output( "EVENT_ARKINV_TRANSMOG_ENTER( ", event, " )" )
...
function ArkInventory:EVENT_ARKINV_EQUIPMENT_SETS_CHANGED( )
	...
	--ArkInventory.Output( "EVENT_ARKINV_EQUIPMENT_SETS_CHANGED( )" )
	
	--ArkInventory.OutputWarning( "EVENT_ARKINV_EQUIPMENT_SETS_CHANGED - .Recalculate" )
...
function ArkInventory:EVENT_ARKINV_BAG_UPDATE_COOLDOWN( event, arg1 )
	
	--ArkInventory.Output( "EVENT_ARKINV_BAG_UPDATE_COOLDOWN( ", arg1, " )" )
...
function ArkInventory:EVENT_ARKINV_CVAR_UPDATE( event, cvar, value )
...
function ArkInventory:EVENT_ARKINV_ZONE_CHANGED_BUCKET( )
	--ArkInventory.Output( "EVENT_ARKINV_ZONE_CHANGED_BUCKET" )
end

function ArkInventory:EVENT_ARKINV_ZONE_CHANGED( event )
	--ArkInventory.OutputDebug( "EVENT_ARKINV_ZONE_CHANGED [", event, "]" )
...
function ArkInventory:EVENT_ARKINV_ACTIONBAR_UPDATE_USABLE( event )
	ArkInventory:SendMessage( "EVENT_ARKINV_ACTIONBAR_UPDATE_USABLE_BUCKET", 1 )
end


function ArkInventory:EVENT_ARKINV_BAG_RESCAN_BUCKET( arg1 )
	
	--ArkInventory.Output( "EVENT_ARKINV_BAG_RESCAN_BUCKET( ", arg1, " )" )
	
	-- arg1 = table in the format blizzard_id=true so we need to loop through them
	
	for blizzard_id in pairs( arg1 ) do
		local loc_id, bag_id = ArkInventory.BlizzardBagIdToInternalId( blizzard_id )
