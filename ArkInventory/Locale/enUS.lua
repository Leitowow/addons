...
--	restack
	...
	L["RESTACK_FILL_FROM_BAGS_TEXT"] = "Fill any empty %1$s slots with Crafting items from your %2$s"
	L["RESTACK_FILL_PRIORITY"] = "Fill Priority"
	L["RESTACK_FILL_PRIORITY_TEXT"] = "Click to toggle between filling up the %1$s or the %2$s first"
...
--	bar menu
	...
	L["MENU_BAR_CATEGORY_TEXT"] = "click to assign category %1$s to bar %2$s"
	...
	L["MENU_BAR_WIDTH_MINIMUM_TEXT"] = "The minimum width for bar %1$s\n\nSet to zero (0) for automatic"
	L["MENU_BAR_WIDTH_MAXIMUM"] = "%1$s (%2$s)"
	L["MENU_BAR_WIDTH_MAXIMUM_TEXT"] = "The maximum width for bar %1$s\n\nSet to zero (0) for automatic"
	...
	L["MENU_LOCKED_LIST_TEXT"] = "This location is using a list view so none of these options are configurable."
...
--	configuration options > system
	L["CONFIG_GENERAL_TEXT"] = "Display Options"
	
	L["CONFIG_GENERAL_FONT_TEXT"] = "select the font to use"
	
	L["CONFIG_GENERAL_FRAMESTRATA"] = "Frame Strata"
	L["CONFIG_GENERAL_FRAMESTRATA_TEXT"] = "select the frameStrata for the windows to be drawn on."
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_LOW"] = "LOW"
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_MEDIUM"] = "MEDIUM"
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_HIGH"] = "HIGH"
	
	L["CONFIG_GENERAL_REPOSITION_ONSHOW"] = "Reposition on Show"
	L["CONFIG_GENERAL_REPOSITION_ONSHOW_TEXT"] = "If a window is off screen this will reposition it back on screen when it is re-opened"
	...
	L["CONFIG_GENERAL_TOOLTIP_ENABLE_TEXT"] = "display tooltips"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD"] = "Empty Line"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"] = "show an empty line between the basic tooltip text and any custom text to be added"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD"] = "Item counts and Gold amounts"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD_TEXT"] = "include item counts in tooltips"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT"] = "set the colour of the item count tooltip text"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS"] = "Tabs"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS_TEXT"] = "include tab numbers for items found in a %1$s" -- %1$s = vault
	L["CONFIG_GENERAL_TOOLTIP_SCALE_TEXT"] = "scales the game, reference and comparison tooltips (game wide)"
	L["CONFIG_GENERAL_TOOLTIP_CLASSCOLOUR_TEXT"] = "use class colours to colour player names"
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY"] = "Self only"
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_TEXT"] = "display data only for the current character"
	L["CONFIG_GENERAL_TOOLTIP_HIGHLIGHT"] = "Self Highlight"
	L["CONFIG_GENERAL_TOOLTIP_HIGHLIGHT_TEXT"] = "text to add to the front of the current characters name to make it more obvious in the list (limit of 3 characters)"
	L["CONFIG_GENERAL_TOOLTIP_FACTION_ONLY"] = "Faction only"
	L["CONFIG_GENERAL_TOOLTIP_FACTION_ONLY_TEXT"] = "display data only for the current characters faction"
	L["CONFIG_GENERAL_TOOLTIP_REALM_ONLY"] = "Realm only"
	L["CONFIG_GENERAL_TOOLTIP_REALM_ONLY_TEXT"] = "display data only for the current characters realm"
	L["CONFIG_GENERAL_TOOLTIP_CROSSREALM"] = "Connected Realms"
	L["CONFIG_GENERAL_TOOLTIP_CROSSREALM_TEXT"] = "display data from realms connected to the current characters realm"
	L["CONFIG_GENERAL_TOOLTIP_VAULT_TEXT"] = "include data from %1$s" -- %1$s = vault
	L["CONFIG_GENERAL_TOOLTIP_BATTLEPET_SOURCE_TEXT"] = "include source text in tooltip"
	L["CONFIG_GENERAL_TOOLTIP_BATTLEPET_DESCRIPTION_TEXT"] = "include description text in tooltip"
	L["CONFIG_GENERAL_TOOLTIP_BATTLEPET_CUSTOM_ENABLE_TEXT"] = "replace the in-built battlepet tooltip with custom tooltip to allow for item counts"
	L["CONFIG_GENERAL_TOOLTIP_BATTLEPET_MOUSEOVER_ENABLE_TEXT"] = "include extra text in mouseover tooltips for player, npc and wild battlepets"
	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_NORMAL_TEXT"] = "What text you want displayed for reputation values in the reputation tooltip."
	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_ITEMCOUNT"] = "Item Count"
	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_ITEMCOUNT_TEXT"] = "What text you want displayed for reputation values in item counts."
	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] = "\n\nIf you use one of the tokens below it will be replaced with the appropriate reputation level value.\n\n*nn* = faction name\n*st* = standing text\n*pv* = paragon level (+N)\n*pr* = paragon reward icon\n*bv* = level value\n*bm* = level max\n*bc* = level value / level max\n*bp* = level percent\n*br* = level remaining"
	
	L["CONFIG_GENERAL_WORKAROUND"] = "Workarounds"
	L["CONFIG_GENERAL_WORKAROUND_TEXT"] = "toggle the code to fix or work around this issue"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL"] = "Frame Level"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_TEXT"] = "A bug in the blizzard CreateFrame API which can cause a frames background to appear above the foreground, item tooltips won't appear and it's impossible to click on anything in the window."
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_TEXT"] = "set how framelevel bug fix alerts are displayed"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"] = "Disabled"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_TEXT"] = "disables bug fix alerts from being displayed"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"] = "Short"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_TEXT"] = "displays the short text for bug fix alerts"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"] = "Full"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_TEXT"] = "displays the full text for bug fix alerts"
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG"] = "Zero Size Bag"
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_TEXT"] = "A potential bug where zero or nil is returned for the size of a bag instead of it's correct size."
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_ALERT_TEXT"] = "display alerts for this bug"
	L["CONFIG_GENERAL_WORKAROUND_THREAD"] = "Threads (co-routines)"
	L["CONFIG_GENERAL_WORKAROUND_THREAD_DEBUG_TEXT"] = "toggle thread debug output\n\nNote: Don't turn this on unless you have a very good reason to do so."
	L["CONFIG_GENERAL_WORKAROUND_THREAD_DISABLED_TEXT"] = "toggle the use of threads (co-routines) - these stop you from getting \"script ran too long\" errors.\n\nNote: Don't turn this off unless you have a very good reason to do so.\n\nThis is a per session variable and will revert back to Enabled at every UI Reload"
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT"] = "Timeout (ms)"
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_NORMAL"] = "Out of Combat"
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_NORMAL_TEXT"] = "the number of milliseconds before the code will yield so it doesnt hit the script timer limit when out of combat "
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_COMBAT"] = "In Combat"
	L["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_COMBAT_TEXT"] = "the number of milliseconds before the code will yield so it doesnt hit the script timer limit when in combat"
	...
	L["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"] = "Show restack notification messages for this location"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION"] = "Translation"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM"] = "Interim"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM_TEXT"] = "Show message for each translation attempt"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL"] = "Final"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL_TEXT"] = "Show final message for successful translation"
	L["CONFIG_GENERAL_MESSAGES_BATTLEPET_OPPONENT"] = "Opponent Details"
	L["CONFIG_GENERAL_MESSAGES_BATTLEPET_OPPONENT_TEXT"] = "Display Opponent Details upon entering a pet battle"
	L["CONFIG_GENERAL_MESSAGES_BAG_UNKNOWN"] = "Unknown Bag Type"
	L["CONFIG_GENERAL_MESSAGES_BAG_UNKNOWN_TEXT"] = "Show a warning message when a bag does not have a valid type and needs to be requeued for scanning"
	L["CONFIG_GENERAL_MESSAGES_RULES_HOOKED"] = "Hooks"
	L["CONFIG_GENERAL_MESSAGES_RULES_HOOKED_TEXT"] = "Show a message when a 3rd party mod is loaded/hooked"
	L["CONFIG_GENERAL_MESSAGES_RULES_REGISTRATION"] = "Registration"
	L["CONFIG_GENERAL_MESSAGES_RULES_REGISTRATION_TEXT"] = "Show a message for each rule registration"
	
	L["CONFIG_GENERAL_TIMERS"] = "Update Timers"
	L["CONFIG_GENERAL_TIMERS_TEXT"] = "use a custom value for the %1$s update timer"
	
	L["CONFIG_GENERAL_TRANSMOG"] = "transmog status icon"
	L["CONFIG_GENERAL_TRANSMOG_SHOW_TEXT"] = "show transmog status icons"
	L["CONFIG_GENERAL_TRANSMOG_SECONDARY"] = "Secondary sources"
	L["CONFIG_GENERAL_TRANSMOG_SECONDARY_TEXT"] = "show status icons for secondary sources. for appearances you've already learnt but not from this source"
	L["CONFIG_GENERAL_TRANSMOG_CLM"] = "Can Learn - Myself"
	L["CONFIG_GENERAL_TRANSMOG_CLM_TEXT"] = "the appearance of this item is unknown, it can be learnt on this character by equipping the item"
	L["CONFIG_GENERAL_TRANSMOG_CLO"] = "Can Learn - Other"
	L["CONFIG_GENERAL_TRANSMOG_CLO_TEXT"] = "the appearance of this item is unknown, it can be learnt on another character of the appropriate class if you mail the item to them"
	L["CONFIG_GENERAL_TRANSMOG_CLMS"] = "Can Learn - Myself - Secondary Source"
	L["CONFIG_GENERAL_TRANSMOG_CLMS_TEXT"] = "the appearance of this item is known, but from another source.  this source can be learnt on this character by equipping the item"
	L["CONFIG_GENERAL_TRANSMOG_CLOS"] = "Can Learn - Other - Secondary Source"
	L["CONFIG_GENERAL_TRANSMOG_CLOS_TEXT"] = "the appearance of this item is known, but from another source.  this source can be learnt on another character of the appropriate class if you mail the item to them"
	
	L["CONFIG_GENERAL_CONFLICT"] = "Addon Conflicts"
	L["CONFIG_GENERAL_CONFLICT_TSM_MAILBOX_TEXT"] = "enable this if you have set TSM to be the mailbox window"
	L["CONFIG_GENERAL_CONFLICT_TSM_MERCHANT_TEXT"] = "enable this if you have set TSM to be the merchant window"
...
--	configuration options > auto
	...
	L["CONFIG_AUTO_OPEN_SCRAP"] = "open a scrapping machine"
	...
	L["CONFIG_AUTO_CLOSE_SCRAP"] = "close a scrapping machine"
...
--	configuration settings > design/style/layout
	...
	L["CONFIG_DESIGN_WINDOW_LIST_TEXT"] = "Display the window content in a list format"
	...
	L["CONFIG_DESIGN_ITEM_ITEMLEVEL_SHOW_MINIMUM_TEXT"] = "minimum item level to show"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT"] = "Stack Limit"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_STACKS"] = "Stacks"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_STACKS_TEXT"] = "only show this many stacks of an item and hide the rest\n\nuse show hidden items to temporarily see all stacks\n\nset to zero to always display all stacks\n\nNote: displayed stacks may not be the newest or largest"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_IDENTIFY_SHOW"] = "Add Indicator"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_IDENTIFY_SHOW_TEXT"] = "add a + character to the item count to indicate there are hidden stacks for that item"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_IDENTIFY_POSITION"] = "Position"
	L["CONFIG_DESIGN_ITEM_STACKLIMIT_IDENTIFY_POSITION_TEXT"] = "where to add the indicator text"
	...
	L["CONFIG_DESIGN_ITEM_STATUSICON_UPGRADE_SHOW_TEXT"] = "show the item upgrade status icon"
	L["CONFIG_DESIGN_ITEM_STATUSICON_JUNK"] = "junk status icon"
	L["CONFIG_DESIGN_ITEM_STATUSICON_JUNK_SHOW_TEXT"] = "show the junk status icon"
	L["CONFIG_DESIGN_ITEM_STATUSICON_QUEST_BANG_TEXT"] = "show the quest bang (!) icon"
	L["CONFIG_DESIGN_ITEM_STATUSICON_QUEST_BORDER_TEXT"] = "show the quest border"
...
-- junk
	...
	L["CONFIG_JUNK_TIMER_TEXT"] = "the number of millseconds to wait before processing the next item"
...
-- sorting
	...
	L["CONFIG_SORTING_INCLUDE_EXPANSION_TEXT"] = "include expansion the item is from when sorting."
...
--	new item indicators
	...
	L["NEW_ITEM_GLOW_CLEAR_TEXT"] = "Clear the New Item Glow when the window is closed"
...
--	slash commands
	...
	L["SLASH_TRACK_ADD_TEXT"] = "Added %1$s to the tracking list"
	L["SLASH_TRACK_REMOVE_TEXT"] = "Removed %1$s from the tracking list"
...
-- libdatabroker
	...
	L["LDB_MOUNTS_USEFORLAND_TEXT"] = "adds your %1$s mounts to your %2$s mount selections"
	...
	L["LDB_COMPANION_USEALL_TEXT"] = "Overrides your selections and uses all available %s, except those marked as ignore"
	L["LDB_COMPANION_RANDOMISE_TEXT"] = "Disabled = Summon the next %1$s sequentially from your list of selections.\n\nEnabled = Summon the next %1$s randomly from your list of selections.\n\nnote: if you have 3 or less usabe %2$s it will always be sequential."
	L["LDB_REPUTATION_TEXT_TEXT"] = "What text you want displayed for reputation values in the objects text."
	L["LDB_REPUTATION_TOOLTIP_TEXT"] = "What text you want displayed for reputation values in the objects tooltip."
