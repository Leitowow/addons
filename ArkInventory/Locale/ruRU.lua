...
--	configuration options > system
	L["CONFIG_GENERAL_TEXT"] = "Системные опции"
	
	L["CONFIG_GENERAL_FONT_TEXT"] = "задает шрифт для %s"
...
--	L["CONFIG_SORTING_WHEN_MANUAL_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_ENABLE_TEXT"] = "включить тултипы"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD"] = "Пустая строка"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"] = "Показывать пустую строку между основным текстом окошка и любым другим текстов"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD"] = "Показывать количество предметов"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD_TEXT"] = "показывать ли количество предметов в тултипе?"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT"] = "задает цвет текста для количества предметов."
...
--	L["CONFIG_GENERAL_TOOLTIP_CLASSCOLOUR_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_TEXT"] = "Показывать количество предметов только для текущего персонажа"
...
--	L["CONFIG_GENERAL_WORKAROUND_TEXT"] = ""
--	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL"] = ""
--	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_TEXT"] = ""
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_TEXT"] = "изменяет как будут показаны сообщения о багфиксах"
--	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"] = ""
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_TEXT"] = "отключает сообщения о багфиксах"
--	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"] = ""
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_TEXT"] = "показывать сокращённую версию сообщений о багфиксах"
--	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"] = ""
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_TEXT"] = "показывать полную версию сообщений о багфиксах"
