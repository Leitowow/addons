...
--	configuration options > system
	L["CONFIG_GENERAL_TEXT"] = "Options système"
	
	L["CONFIG_GENERAL_FONT_TEXT"] = "Sélectionner la police de caractère à utiliser"
...
--	L["CONFIG_SORTING_WHEN_MANUAL_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_ENABLE_TEXT"] = "Montrer les informations supplémentaires dans la bulle d'information"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD"] = "Ligne vide"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"] = "Mettre une ligne vide entre le texte de base de la bulle d'information et le texte personnalisé à ajouter"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD"] = "Quantité d'objet"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD_TEXT"] = "Montrer la quantité d'objets dans la bulle d'information"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT"] = "Définir la couleur du texte pour la quantité d'objets"
...
--	L["CONFIG_GENERAL_TOOLTIP_CLASSCOLOUR_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_TEXT"] = "Montrer la quantité d'objets seulement pour ce personnage"
...
--	L["CONFIG_GENERAL_WORKAROUND"] = ""
	L["CONFIG_GENERAL_WORKAROUND_TEXT"] = "Activer le code pour corriger ou contourner ce problème"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL"] = "FrameLevel"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_TEXT"] = "Un bogue dans l'API CreateFrame de Blizzard peut faire apparaitre le fond des cadres devant l'avant-plan, les fenêtres d'aide des objets n'apparaissent pas et il est impossible de cliquer sur quelque chose dans la fenêtre."
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_TEXT"] = "Définir comment sont afficher les alertes de la correction du bogue de FrameLevel"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"] = "Désactivée"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_TEXT"] = "Les alertes de la correction du bogue ne seront pas affichées"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"] = "Courte"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_TEXT"] = "Afficher un court texte des alertes de la correction du bogue"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"] = "Complète"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_TEXT"] = "Afficher le texte complet des alertes de la correction du bogue"
