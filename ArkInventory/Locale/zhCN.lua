...
--	configuration options > system
	L["CONFIG_GENERAL_TEXT"] = "系统选项"
	
	L["CONFIG_GENERAL_FONT_TEXT"] = "设置 %s 的字体"
	
	L["CONFIG_GENERAL_FRAMESTRATA"] = "框架优先级"
	L["CONFIG_GENERAL_FRAMESTRATA_TEXT"] = "选择窗口优先级。"
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_LOW"] = "低"
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_MEDIUM"] = "中等"
	L["CONFIG_GENERAL_FRAMESTRATA_LEVEL_HIGH"] = "高"
	
--	L["CONFIG_GENERAL_REPOSITION_ONSHOW"] = "加载时复位"
--	L["CONFIG_GENERAL_REPOSITION_ONSHOW_TEXT"] = "首次查看时，复位 %1$s 窗口" -- %1$s = location name
...
--	L["CONFIG_SORTING_WHEN_MANUAL_TEXT"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP_ENABLE_TEXT"] = "是否使用提示"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD"] = "空行"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"] = "是否在基础提示文字和自定义文字之间显示一个空行"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD"] = "显示物品数量"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD_TEXT"] = "设定提示中是否显示物品数量"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT"] = "设定物品数量文字颜色"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS"] = "显示标签"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS_TEXT"] = "显示 %1$s 中的物品标签ID" -- %1$s = vault
	L["CONFIG_GENERAL_TOOLTIP_SCALE_TEXT"] = "游戏缩放比例，参照（游戏宽度）"
	L["CONFIG_GENERAL_TOOLTIP_CLASSCOLOUR_TEXT"] = "使用职业颜色显示玩家名称"
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY"] = "当前角色"
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_TEXT"] = "只显示当前角色的物品计数"
--	L["CONFIG_GENERAL_TOOLTIP_HIGHLIGHT"] = ""
--	L["CONFIG_GENERAL_TOOLTIP_HIGHLIGHT_TEXT"] = ""
	L["CONFIG_GENERAL_TOOLTIP_FACTION_ONLY"] = "仅当前阵营"
	L["CONFIG_GENERAL_TOOLTIP_FACTION_ONLY_TEXT"] = "只显示当前阵营数据"
...
--	L["CONFIG_GENERAL_TOOLTIP_CROSSREALM_TEXT"] = ""
	L["CONFIG_GENERAL_TOOLTIP_VAULT_TEXT"] = "包括 %1$s 的数据" -- %1$s = vault
...
--	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] = ""
	...
	L["CONFIG_GENERAL_WORKAROUND_TEXT"] = "切换代码修正或者绕开这个问题"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL"] = "框架级别"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_TEXT"] = "一个出自暴雪CreateFrame API的错误, 有可能引致框架背景在前景上出现的情况, 物品提示不会出现, 而且也不可能点击那个窗口里的任何东西."
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_TEXT"] = "改变错误修正警告的显示方式"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"] = "禁用"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_TEXT"] = "禁用错误修正警告"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"] = "短"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_TEXT"] = "以简短模式显示错误修正警告"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"] = "长"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_TEXT"] = "以详细模式显示错误修正警告"
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG"] = "无空间背包"
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_TEXT"] = "一个未知的bug，导致无法正常获取背包当前空间."
	L["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_ALERT_TEXT"] = "显示此Bug警告"
...
--	L["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"] = ""
	...
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM_TEXT"] = "显示尝试翻译每个条目的信息"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL"] = "最终的"
	L["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL_TEXT"] = "显示最终成功翻译的信息"
