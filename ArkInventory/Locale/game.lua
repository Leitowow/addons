...
L["PT_CATEGORY_ARTIFACT_POWER"] = "Consumable.Artifact Power"
...
L["TOOLTIP_NOT_READY"] = RETRIEVING_ITEM_INFO or true
...
L["PET_BATTLE_BOUND"] = string.format( "%s (%s)", TOOLTIP_BATTLE_PET, ITEM_SOULBOUND )
L["PET_COMPANION_BOUND"] = string.format( "%s (%s)", PET, ITEM_SOULBOUND )
