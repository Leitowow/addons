...
local cfg = {}
cfg.pos = {"BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", SUIDB.TOOLTIP.X, SUIDB.TOOLTIP.Y}
...
--texture
GameTooltipStatusBar:SetStatusBarTexture("Interface\\Addons\\SUI\\inc\\media\\unitframes\\UI-TargetingFrame-BarFill")
