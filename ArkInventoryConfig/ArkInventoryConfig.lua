...
$Revision: 2315 $
$Date: 2019-02-25 20:49:14 +1100 (Mon, 25 Feb 2019) $
...
function ArkInventory.ConfigInternal( )
	...
	path.args = {
		...
		general = {
			...
			desc = ArkInventory.Localise["CONFIG_GENERAL_TEXT"],
			type = "group",
			childGroups = "tab",
			args = {
				font = {
					...
					desc = ArkInventory.Localise["CONFIG_GENERAL_FONT_TEXT"],
					type = "select",
					width = "double",
				...
				reposition = {
					...
					desc = ArkInventory.Localise["CONFIG_GENERAL_REPOSITION_ONSHOW_TEXT"],
					type = "toggle",
					get = function( info )
					...
					args = {
						auto_open = {
							...
							args = {
								...
								scrap = {
									order = 800,
									name = ArkInventory.Localise["CONFIG_AUTO_OPEN_SCRAP"],
									type = "toggle",
									width = "double",
									get = function( info )
						...
						auto_close = {
							...
							args = {
								...
								scrap = {
									order = 800,
									name = ArkInventory.Localise["CONFIG_AUTO_CLOSE_SCRAP"],
									type = "toggle",
									width = "double",
									get = function( info )
				...
				tooltip = {
					...
					args = {
						basic = {
							...
							args = {
								show = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ENABLE_TEXT"],
									type = "toggle",
									get = function( info )
								...
								paint = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_CLASSCOLOUR_TEXT"],
									type = "toggle",
								...
								empty = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_TEXT"],
									type = "toggle",
									disabled = function( info )
										return not ArkInventory.db.option.tooltip.show
									end,
						...
						scale = {
							...
							args = {
								enabled = {
									order = 100,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_SCALE_TEXT"],
									type = "toggle",
									get = function( info )
						...
						count = {
							order = 300,
							name = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD"],
							type = "group",
							--inline = true,
							disabled = function( info )
								return not ArkInventory.db.option.tooltip.show
							...
							args = {
								enabled = {
									order = 100,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ADD_TEXT"],
									type = "toggle",
									get = function( info )
								...
								colour = {
									order = 200,
									name = ArkInventory.Localise["COLOUR"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT"],
									type = "color",
									hasAlpha = false,
									disabled = function( )
								...
								me = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_TEXT"],
									type = "toggle",
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.add.count
									end,
								...
								highlight = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_HIGHLIGHT_TEXT"],
									type = "input",
									width = "half",
									disabled = function( )
								...
								faction = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_FACTION_ONLY_TEXT"],
									type = "toggle",
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.add.count or ArkInventory.db.option.tooltip.me
									end,
								...
								realm = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REALM_ONLY_TEXT"],
									type = "toggle",
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.add.count or ArkInventory.db.option.tooltip.me
									end,
								...
								crossrealm = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_CROSSREALM_TEXT"],
									type = "toggle",
									disabled = function( )
								...
								vault = {
									...
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_VAULT_TEXT"], ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].Name ),
									type = "toggle",
									disabled = function( )
										return not ArkInventory.db.option.tooltip.show or not ArkInventory.db.option.tooltip.add.count or ArkInventory.db.option.tooltip.me
									end,
								...
								showtabs = {
									order = 600,
									name = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS"],
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_VAULT_TABS_TEXT"], ArkInventory.Global.Location[ArkInventory.Const.Location.Vault].Name ),
									type = "toggle",
									disabled = function( )
								...
								custom = {
									...
									args = {
										enabled = {
											order = 100,
											name = ArkInventory.Localise["ENABLED"],
											desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_BATTLEPET_CUSTOM_ENABLE_TEXT"],
											type = "toggle",
											get = function( info )
										...
										source = {
											order = 200,
											name = SOURCES,
											desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_BATTLEPET_SOURCE_TEXT"],
											type = "toggle",
											disabled = function( )
										...
										description = {
											...
											desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_BATTLEPET_DESCRIPTION_TEXT"],
											type = "toggle",
											disabled = function( )
												return not ArkInventory.db.option.tooltip.battlepet.enable
											end,
								...
								mouseover = {
									...
									args = {
										enabled = {
											order = 100,
											name = ArkInventory.Localise["ENABLED"],
											desc = ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_BATTLEPET_MOUSEOVER_ENABLE_TEXT"],
											type = "toggle",
											get = function( info )
						...
						reputation = {
							...
							args = {
								...
								style_normal = {
									...
									desc = string.format( "%s%s", ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_NORMAL_TEXT"],ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] ),
									type = "input",
									width = "double",
									disabled = function( )
								...
								style_count = {
									...
									desc = string.format( "%s%s", ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_ITEMCOUNT_TEXT"],ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] ),
									type = "input",
									width = "double",
									disabled = function( )
										return ArkInventory.db.option.tooltip.reputation.custom == ArkInventory.Const.Reputation.Custom.Default
					...
					args = {
						framelevel = {
							...
							args = {
								desc = {
									order = 100,
									name = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_TEXT"],
									type = "description",
								},
								enabled = {
									order = 200,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_TEXT"],
									type = "toggle",
									get = function( info )
								...
								alert = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_TEXT"],
									type = "select",
									disabled = function( )
									...
									values = function( )
										local t = { }
										t[0] = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0"]
										t[1] = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1"]
										t[2] = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2"]
										return t
									end,
									get = function( info )
						...
						zerosizebag = {
							...
							args = {
								desc = {
									order = 100,
									name = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_TEXT"],
									type = "description",
								},
								enabled = {
									order = 200,
								...
								alert = {
									order = 300,
									name = ArkInventory.Localise["ALERT"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_ZEROSIZEBAG_ALERT_TEXT"],
									type = "toggle",
									disabled = function( )
				...
				thread = {
					...
					args = {
						use = {
							order = 100,
							name = ArkInventory.Localise["ENABLED"],
							desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_DISABLED_TEXT"],
							type = "toggle",
							get = function( info )
						...
						debugged = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_DEBUG_TEXT"],
							type = "toggle",
							get = function( info )
						...
						timeout_normal = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_NORMAL_TEXT"],
							type = "range",
							min = 25,
							max = 5000,
							step = 5,
						...
						timeout_combat = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD_TIMEOUT_COMBAT_TEXT"],
							type = "range",
							min = 25,
							max = 250,
							step = 5,
						...
						bag = {
							...
							args = {
								custom = {
									order = 100,
									name = ArkInventory.Localise["CUSTOM"],
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_TIMERS_TEXT"], ArkInventory.Localise["BACKPACK"] ),
									type = "toggle",
									get = function( info )
						...
						mail = {
							...
							args = {
								custom = {
									order = 100,
									name = ArkInventory.Localise["CUSTOM"],
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_TIMERS_TEXT"], ArkInventory.Localise["MAILBOX"] ),
									type = "toggle",
									get = function( info )
						...
						vault = {
							...
							args = {
								custom = {
									order = 100,
									name = ArkInventory.Localise["CUSTOM"],
									desc = string.format( ArkInventory.Localise["CONFIG_GENERAL_TIMERS_TEXT"], ArkInventory.Localise["VAULT"] ),
									type = "toggle",
									get = function( info )
						...
						restack = {
							...
							args = {
								bag = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RESTACK_TEXT"],
									type = "toggle",
									get = function( info )
						...
						translation = {
							...
							args = {
								interim = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_TRANSLATION_INTERIM_TEXT"],
									type = "toggle",
									get = function( info )
								...
								final = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_TRANSLATION_FINAL_TEXT"],
									type = "toggle",
									get = function( info )
						...
						battlepet = {
							...
							args = {
								opponent = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_BATTLEPET_OPPONENT_TEXT"],
									type = "toggle",
									get = function( info )
						...
						bagunknown = {
							...
							args = {
								enabled = {
									order = 100,
									name = ArkInventory.Localise["ENABLED"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_BAG_UNKNOWN_TEXT"],
									type = "toggle",
									get = function( info )
						...
						rules = {
							...
							args = {
								hooked = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RULES_HOOKED_TEXT"],
									type = "toggle",
									get = function( info )
								...
								registration = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_MESSAGES_RULES_REGISTRATION_TEXT"],
									type = "toggle",
									get = function( info )
				...
				junk = {
					...
					args = {
						...
						junksell = {
							order = 800,
							name = ArkInventory.Localise["CONFIG_GENERAL_WORKAROUND_THREAD"],
							desc = ArkInventory.Localise["CONFIG_JUNK_TIMER_TEXT"],
							type = "range",
							min = 25,
							max = 2500,
							step = 5,
							disabled = function( )
								return not ArkInventory.Global.Thread.Use or not ArkInventory.db.option.junk.sell
							end,
							get = function( info )
				...
				transmog = {
					...
					args = {
						show1 = {
							order = 10,
							name = ArkInventory.Localise["ENABLED"],
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_SHOW_TEXT"],
							type = "toggle",
							get = function( info )
						...
						show2 = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_SECONDARY_TEXT"],
							type = "toggle",
							disabled = function( info )
						...
						clm_icon = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_CLM_TEXT"],
							type = "select",
							width = "double",
						...
						clo_icon = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_CLO_TEXT"],
							type = "select",
							width = "double",
							dialogControl = "LSM30_Background",
							values = ArkInventory.Lib.SharedMedia:HashTable( ArkInventory.Const.Transmog.SharedMediaType ),
						...
						clms_icon = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_CLMS_TEXT"],
							type = "select",
							width = "double",
							dialogControl = "LSM30_Background",
							values = ArkInventory.Lib.SharedMedia:HashTable( ArkInventory.Const.Transmog.SharedMediaType ),
						...
						clos_icon = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_TRANSMOG_CLOS_TEXT"],
							type = "select",
							width = "double",
							dialogControl = "LSM30_Background",
							values = ArkInventory.Lib.SharedMedia:HashTable( ArkInventory.Const.Transmog.SharedMediaType ),
						...
						tsm = {
							...
							args = {
								mailbox = {
									order = 100,
									name = ArkInventory.Localise["MAILBOX"],
									desc = ArkInventory.Localise["CONFIG_GENERAL_CONFLICT_TSM_MAILBOX_TEXT"],
									type = "toggle",
									get = function( info )
								...
								merchant = {
									...
									desc = ArkInventory.Localise["CONFIG_GENERAL_CONFLICT_TSM_MERCHANT_TEXT"],
									type = "toggle",
									get = function( info )
				...
				interface = {
					...
					args = {
						...
						strata = {
							...
							desc = ArkInventory.Localise["CONFIG_GENERAL_FRAMESTRATA_TEXT"],
							type = "select",
							values = function( )
								local t = {
									[1] = ArkInventory.Localise["CONFIG_GENERAL_FRAMESTRATA_LEVEL_LOW"],
									[2] = ArkInventory.Localise["CONFIG_GENERAL_FRAMESTRATA_LEVEL_MEDIUM"],
									[3] = ArkInventory.Localise["CONFIG_GENERAL_FRAMESTRATA_LEVEL_HIGH"],
								}
								return t
							end,
							get = function( info )
				...
				bags = {
					...
					args = {
						colour = {
							...
							get = function( info )
								return me.player.data.ldb.bags.colour
							end,
							set = function( info, v )
								me.player.data.ldb.bags.colour = v
						...
						full = {
							...
							get = function( info )
								return me.player.data.ldb.bags.full
							end,
							set = function( info, v )
								me.player.data.ldb.bags.full = v
								ArkInventory.LDB.Bags:Update( )
							end,
						},
						includetype = {
							...
							get = function( info )
								return me.player.data.ldb.bags.includetype
							end,
							set = function( info, v )
								me.player.data.ldb.bags.includetype = v
								ArkInventory.LDB.Bags:Update( )
							end,
						},
					},
...
--				},
				...
				reputation = {
					...
					args = {
						...
						style1 = {
							...
							desc = string.format( "%s%s", ArkInventory.Localise["LDB_REPUTATION_TEXT_TEXT"],ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] ),
							type = "input",
							width = "double",
							disabled = function( )
						...
						style2 = {
							order = 320,
							name = ArkInventory.Localise["TOOLTIP"],
							desc = string.format( "%s%s", ArkInventory.Localise["LDB_REPUTATION_TOOLTIP_TEXT"],ArkInventory.Localise["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_TEXT"] ),
							type = "input",
							width = "double",
							disabled = function( )
								return ArkInventory.db.option.tracking.reputation.custom == ArkInventory.Const.Reputation.Custom.Default
	...
	ArkInventory.ConfigInternalLDBPets( path.args.ldb.args.pets.args )
	
end

function ArkInventory.ConfigInternalControl( path )
...
function ArkInventory.ConfigInternalCategoryCustom( )
	...
	local path = ArkInventory.Config.Internal.args.category_custom
...
function ArkInventory.ConfigInternalCategoryRule( )
	...
	local path = ArkInventory.Config.Internal.args.category_rule.args.rules
...
function ArkInventory.ConfigInternalCategorysetDataCustom( path )
	...
	path.args = {
		...
		list_reload = {
			...
			hidden = true,
			func = function( )
				ArkInventory.ConfigInternalCategorysetCustom( )
			end,
		},
	}
...
function ArkInventory.ConfigInternalCategorysetDataRule( path )
	...
	path.args = {
		...
		list_reload = {
			...
			hidden = true,
			func = function( )
				ArkInventory.ConfigInternalCategorysetDataRule( path )
			end,
		},
	}
...
function ArkInventory.ConfigInternalDesignData( path )
	...
	local args1 = {
		...
		basics = {
			order = 10,
			name = ArkInventory.Localise["CONFIG_DESIGN"],
			type = "group",
			childGroups = "tab",
			--disabled = ArkInventory.Global.Options.ConfigDesignListShow ~= 1,
			args = {
						...
						window = {
							...
							args = {
								showaslist = {
									...
									desc = ArkInventory.Localise["CONFIG_DESIGN_WINDOW_LIST_TEXT"],
									get = function( info )
										local id = ConfigGetNodeArg( info, #info - 4 )
										local style = ArkInventory.ConfigInternalDesignGet( id )
			...
			args = {
				style = {
					...
					args = {
						...
						statusicon = {
							order = 130,
							name = ArkInventory.Localise["CONFIG_DESIGN_ITEM_STATUSICON"],
							type = "group",
							childGroups = "tab",
							args = {
								upgrade = {
									...
									args = {
										show = {
											order = 10,
											name = ArkInventory.Localise["ENABLED"],
											desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_STATUSICON_UPGRADE_SHOW_TEXT"],
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
								...
								junk = {
									...
									args = {
										show = {
											order = 10,
											name = ArkInventory.Localise["ENABLED"],
											desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_STATUSICON_JUNK_SHOW_TEXT"],
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
								...
								transmog = {
									...
									args = {
										moved = {
											...
											type = "description",
											name = function( )
												return string.format( "\nmoved to %s > %s", ArkInventory.Localise["GENERAL"], ArkInventory.Localise["TRANSMOGRIFY"] )
											end,
										},
									},
								},
								quest = {
									...
									args = {
										bang = {
											...
											desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_STATUSICON_QUEST_BANG_TEXT"],
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
										...
										border = {
											order = 20,
											name = ArkInventory.Localise["BORDER"],
											desc = ArkInventory.Localise["CONFIG_DESIGN_ITEM_STATUSICON_QUEST_BORDER_TEXT"],
											type = "toggle",
											get = function( info )
												local id = ConfigGetNodeArg( info, #info - 5 )
												local style = ArkInventory.ConfigInternalDesignGet( id )
...
function ArkInventory.ConfigInternalProfile( )
	...
	local path = ArkInventory.Config.Internal.args.myprofiles.args.profiles
...
function ArkInventory.ConfigInternalProfileData( path )
	...
	ArkInventory.ConfigInternalControl( args1.control.args )
