...
$Revision: 2244 $
$Date: 2018-09-16 11:29:13 +1000 (Sun, 16 Sep 2018) $
...
function ArkInventoryRules.System.value_itemlevel( )
	return ArkInventoryRules.Object.info.ilvl or 0
end
...
function ArkInventoryRules.System.value_count( )
	return ArkInventoryRules.Object.count or 0
end
...
function ArkInventoryRules.System.boolean_expansion( ... )
	...
	if not ArkInventoryRules.Object.info.expansion then
		return false
	end
...
function ArkInventoryRules.System.boolean_tooltip( ... )
	...
	if ArkInventoryRules.Object.test_rule or ArkInventory.Global.Location[ArkInventoryRules.Object.loc_id].isOffline then
		...
		ArkInventory.TooltipSetItem( ArkInventoryRules.Tooltip, blizzard_id, ArkInventoryRules.Object.slot_id )
	end
...
function ArkInventoryRules.System.boolean_outfit( ... )
	...
	if IsAddOnLoaded( "Outfitter" ) and Outfitter:IsInitialized( ) and ArkInventoryRules.System.boolean_outfit_outfitter( ... ) then
		return true
	end
	
	if IsAddOnLoaded( "ItemRack" ) and ArkInventoryRules.System.boolean_outfit_itemrack( ... ) then
		return true
	end
...
function ArkInventoryRules.System.boolean_trash( )
...
function ArkInventoryRules.System.boolean_transmog( )
	...
	return not not ArkInventory.ItemTransmogState( ArkInventoryRules.Object.h, ArkInventoryRules.Object.sb, ArkInventoryRules.Object.loc_id, true )
...
function ArkInventoryRules.System.boolean_tsmgroup4( ... )
	...
	local group = TSM_API.GetGroupPathByItem( ArkInventoryRules.Object.h ) or TSM_API.GetGroupPathByItem( ArkInventoryRules.Object.osd.id )
	if not group then
		return false
	end
...
ArkInventoryRules.Environment = {
	...
	trash = ArkInventoryRules.System.boolean_trash,
...
function ArkInventoryRules.EntryIsValid( rid, data )
	...
	if not data.formula or string.trim( data.formula ) == "" then
		...
		ArkInventoryRules.SetObject( { test_rule=true, class="item", bag_id=0, slot_id=1, count=1, q=1, sb=ArkInventory.Const.Bind.Pickup, h=string.format("item:%s:::::::", HEARTHSTONE_ITEM_ID ) } )
